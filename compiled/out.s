...
/*
********HAM PRIME**********
Compiled with love on Mon Feb 17 2025 12:19:33 GMT-0700 (Mountain Standard Time)
**************************
*/
...
__ALLOCFOR___constructor_List_0___ = 4
.type	__constructor_List_1_, @function
.global __constructor_List_1_
__ALLOCFOR___constructor_List_1___ = 8
...
# popping multi-line clobbers
	...
	#//------- line: { ; ------- #
	# {
		# creating variable "___CONSTRUCTOR_SAVE___" of type "List:dynamic" stack?=true
...
# popping multi-line clobbers
	...
	pop %esi
	# clobbering "i"
	#//------- line: printf ( __STRING3__,,,%esi,,,%edi ) ------- #
	# pushing clobbers
	push %esi
	push %ecx
	push %edi
...
pop %ecx
	...
	#//------- line: printf ( __STRING4__,,,12(%ebp),,,8(%ebp) ) ------- #
	# pushing clobbers
	push %ecx
	# Calling function printf
	# TODO optimize if variable just do movl
